...
import { initOpusEncoder } from './opus-codec.js?v=0310-1';
import { getAudioPlayer } from './player.js?v=0310-1';
...
export class AudioRecorder {
    ...
    async start() {
        ...
        try {
            ...
            const { getWebSocketHandler } = await import('../network/websocket.js?v=0310-1');
